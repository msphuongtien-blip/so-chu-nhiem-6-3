 ...
 *
 * Các query độc lập được chạy song song bằng Promise.all. `head: true` chỉ
 * yêu cầu metadata số dòng, tránh tải toàn bộ bản ghi về browser.
 *
 ...
 *
 * Đây là hard delete có chủ đích cho dữ liệu test/chưa phát sinh lịch sử.
...
/**
 * Khởi tạo observer cho bảng học sinh.
 */
