...
assert.ok(source.includes('buildStudentPickerMarkupV6()'));
assert.ok(source.includes('getCompetitionRecordSelectedStudentsV6()'));
...
assert.ok(source.includes('saveCompetitionRecordsV6('));
